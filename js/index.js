(function() {
    ...
    function displayBip32Info() {
		...
		console.log('After displayAddresses-1');
    ...
    function showMore() {
		...
		//console.log('After displayAddresses-2');
    }
    ...
    function addAddressToList(indexText, address, pubkey, privkey) {
		console.log('addAddressToList ', indexText, address);
    ...
    function displayBip32InfoForELA() {
        ...
        var initialAddressCount = parseInt(DOM.rowsToAdd.val());
        displayAddresses(0, initialAddressCount);
		//console.log('After displayAddresses-3');
    }
